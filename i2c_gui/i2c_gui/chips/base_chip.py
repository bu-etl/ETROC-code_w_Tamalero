...
class Base_Chip(GUI_Helper):
    ...
    def __init__(self, parent: GUI_Helper, chip_name: str, version: str, i2c_controller: Connection_Controller, register_model = None, register_decoding = None, indexer_info = None, rb=None, lpgbt=None):
